...
//        Assert.assertEquals(codegen.additionalProperties().get(SpringCodegen.USE_RESPONSE_ENTITY), true);
    ...
    public void shouldAddValidAnnotationIntoCollectionWhenBeanValidationIsEnabled_issue17150() throws IOException {
        ...
        JavaFileAssert.assertThat(files.get("Foo.java"))
                ...
                .withType("List<@Min(value = 1) @Max(value = 10) Integer>")
                .toType()
                .assertProperty("intMin")
                .withType("List<@Min(value = 1) Integer>")
                .toType()
                .assertProperty("intMax")
                .withType("List<@Max(value = 10) Integer>")
                .toType()
                .assertProperty("numberMinMax")
                .withType("List<@Valid @DecimalMin(value = \"1\") @DecimalMax(value = \"10\") BigDecimal>")
                .toType()
                .assertProperty("numberMin")
                .withType("List<@Valid @DecimalMin(value = \"1\") BigDecimal>")
                .toType()
                .assertProperty("numberMax")
                .withType("List<@Valid @DecimalMax(value = \"10\") BigDecimal>")
                .toType()
                ...
                .withType("JsonNullable<List<@Min(value = 1) @Max(value = 10) Integer>>")
                .toType()
                .assertProperty("intMinNullable")
                .withType("JsonNullable<List<@Min(value = 1) Integer>>")
                .toType()
                .assertProperty("intMaxNullable")
                .withType("JsonNullable<List<@Max(value = 10) Integer>>")
                .toType()
                .assertProperty("numberMinMaxNullable")
                .withType("JsonNullable<List<@Valid @DecimalMin(value = \"1\") @DecimalMax(value = \"10\") BigDecimal>>")
                .toType()
                .assertProperty("numberMinNullable")
                .withType("JsonNullable<List<@Valid @DecimalMin(value = \"1\") BigDecimal>>")
                .toType()
                .assertProperty("numberMaxNullable")
                .withType("JsonNullable<List<@Valid @DecimalMax(value = \"10\") BigDecimal>>")
                .toType()
        ;
    }
    ...
    void shouldNotIncludeProblemJsonInHttpExchangeAcceptHeader() throws IOException {
        ...
        JavaFileAssert.assertThat(files.get("DefaultApi.java"))
                .assertMethod("getImage")
                .assertMethodAnnotations()
                .containsWithNameAndAttributes("HttpExchange", Map.of("accept", "{ \"image/png\" }"));

    }

    @Test
    void shouldNotIncludeProblemJsonInRequestMappingProduces() throws IOException {
        ...
        JavaFileAssert.assertThat(files.get("ImageApi.java"))
                .assertMethod("getImage")
                .assertMethodAnnotations()
                .containsWithNameAndAttributes("RequestMapping", Map.of("produces", "{ \"image/png\" }"));

    }

    @Test
    void shouldGenerateCorrectMediaTypesForApiResponses() throws IOException {
        Map<String, File> files = generateFromContract("src/test/resources/3_0/spring/no-problem-json-in-response.yaml", SPRING_BOOT,
                Map.of(GENERATE_APIS, false, INTERFACE_ONLY, true, SKIP_OPERATION_EXAMPLE, true, SKIP_DEFAULT_INTERFACE, true));
